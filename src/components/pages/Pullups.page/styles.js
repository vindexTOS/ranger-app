...
export const style = {
  ...
  sugheader: `w-[4rem] h-[4rem] text-[2rem] max_md:w-[2.5rem] max_md:text-[1.3rem]   text-center flex justify-center items-center text-orange-500 font-bold border-l-2 border-b-2  border-orange-400 rounded-l-[40px] `,
  input: ` pushup-input text-center  w-[9rem] h-[4rem]  border-orange-400  text-[3rem] border-b-2 border-r-2 rounded-r-[40px] text-orange-600 flex items-center justify-center`,
  inputDiv: `flex flex-col gap-2 mt-10  `,
  singleInput: ` flex flex-row items-center justify-center gap-10`,
  spanP: `text-orange-500 flex items-center  rounded-[12px] text-center mb-[5px]`,
}
export const prevStyle = {
  prevPush: ` max_md:w-[4rem] border-orange-400 border-l-2 rounded-l-[50%] rounded-r-[40%]  border-b-2 rounded-[8px] h-[5rem] w-[5rem] flex items-center justify-center`,
  mainDiv: `flex gap-2 max_md:items-center max_md:justify-center   `,
  sets: `text-[2.7rem] text-orange-500 `,
  header: `  z-20 font-bold flex flex-col itmes-center text-center justify-center border-orange-400 border-t-2 rounded-t-[40px] w-[30rem] max_md:w-[18rem] max_md:w-[24rem] max_md:ml-[1.2rem] `,
...
export const inputDiv = (con, setCon, getVal, suggestions) => {
  ...
  const { register, getValues } = PullUpUseContext()
