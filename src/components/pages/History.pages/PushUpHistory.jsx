...
function History() {
  ...
  const style = {
    mainDiv: `   w-[90%]    text  h-[280px] border-t-2 border-green-400  orange  pb-4  max_xl:ml-10`,
    ...
    timeDiv: `  flex  text-color  items-center border-green-400  border-b-2 justify-center   font-bold  overflow-hidden text-[12px] h-[2rem] w-[50%]`,
    setDiv: `flex gap-2 flex-row `,
    setHeader: `  w-[1.7rem] text-center text-color   border-green-400 border-b-2   `,
