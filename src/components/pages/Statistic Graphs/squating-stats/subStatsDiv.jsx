...
const subStatsDiv = (img, state, title) => {
  const style = {
    div: `flex flex-col items-center justify-center w-[15rem] h-[10rem] border-blue-400  max_sm:w-[50%] max_sm:h-[9rem] max_sm:bg-orange-400  border-l-2 border-b-2 bg-[#fcfcfa] rounded-[5px] `,
