...
function MaxTestRoom() {
  ...
  const style = {
    mainDiv: `w-[100vw] h-[100vh]  gap-10 max_sm:h-[1500px]  border-2 flex m-0 p-0  flex-col items-center justify-center max_sm:justify-start max_sm:items-center rounded-[8px] max_sm:border-0  max_sm:gap-5  max_lg:h-[1500px]    border-l-0 `,
    ...
    testDivWrapper: `w-[100%] h-[50%] gap-5 flex flex-wrap  justify-center   `,
    testDiv: ` bg-red-500 w-[300px]    max_sm:h-[300px] max_lg:h-[400px]  h-[100%] rounded-[19px]  cardshaddow flex flex-col items-center justify-center text-orange-200 text-[1.3rem] gap-2 cursor-pointer`,
    testIcon: `w-[200px] h-[200px]`,
    flipTestDiv: `w-[100px] h-[100%] max_lg:h-[400px]  max_sm:h-[300px] rounded-[19px] bg-orange-200 cardshaddow flex flex-col items-center justify-center gap-5 text-orange-200 text-[1.3rem]  cursor-pointer border-r-2`,
