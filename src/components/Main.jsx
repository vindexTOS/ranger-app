...
function Main() {
  ...
  const style = {
    ...
    workDiv: ` flex  flex-row  w-[90%] h-[100%]  gap-10 mt-5 ml-[4rem] max_xl:ml-20 max_Xll:ml-[5rem] items-center justify-between max_xl:gap-5     `,
    compDiv: `flex flex-col gap-10  mb-10 max_lg:hidden     `,
